...
function getQuote(address: string, method: DeliveryMethod) {
  ...
  return {
    ...
    etaDays: method === "cdek" ? "2-4 дня" : "3-4 дня",
    carrierLabel: carrierLabels[method],
    zoneLabel: "",
    note:
      "Стоимость доставки на сайте указана приблизительно. Точный тариф зависит от выбранной службы (Яндекс Доставка/СДЭК) и оплачивается получателем при получении.",
  };
}
