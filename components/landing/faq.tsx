...
const faqItems = [
  ...
  },
  {
    ...
    a: "Для каждого заказа мы сохраняем привязку к выбранному приюту в базе, переводим средства в конкретную организацию и фиксируем данные. На этапе масштабирования публикуем сводную отчётность — так же, как делают наши приюты-партнёры в своей отчётности.",
  },
  {
