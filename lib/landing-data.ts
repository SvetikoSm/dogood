...
export const shelters: Shelter[] = [
  ...
  {
    id: "super-sobaka",
    name: "Центр Помощи Французским Бульдогам «Френчбуль Хелп»",
    city: "Москва",
    description:
  ...
  },
  {
    ...
    detailBlocks: [
      ...
      "Анкеты животных, новости и отчёты по сборам — на сайте; живые фото и будни приюта — в Instagram.",
    ],
    socialLinks: [
...
/** В заявке показываем все приюты, но «Френчбуль Хелп» — первым. */
