...
export const shelters: Shelter[] = [
  ...
  },
  {
    ...
    detailBlocks: [
      "Это муниципальный приют с понятными правилами: анкеты подопечных, новости и то, чем реально можно помочь, — всё собрано на их страницах (ссылки ниже).",
...
/** В заявке показываем все приюты, но Shelter Tails — первым. */
export const sheltersForOrderForm = [
  ...shelters.filter((s) => s.id === "shelter-tails"),
  ...shelters.filter((s) => s.id !== "shelter-tails"),
];
